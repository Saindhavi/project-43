...
function clues() {
    ...
    fill("white")
    textSize(15)
    text("A T A D A S B E", 100,200)
    fill("lightblue")
    text("Hint: collection of structred information or data!!", 100,220)

    fill("white")
    textSize(15)
    text("C U T N I F O N", 100,250)
    fill("lightblue")
    text("Hint: modules of code that accomplish a specific task!!", 100,270)
